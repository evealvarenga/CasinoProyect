...
public class Seed {
	...
	public static void cargarClientes(ArrayList<Cliente> listaClientes) {
		listaClientes.add(new Cliente(55555555, "Juan Pérez", "Calle Falsa 123", 11223344, "juan@gmail.com"));
		listaClientes.add(new Cliente(66666666, "Juan Pérez", "Calle Falsa 123", 11223344, "juan@gmail.com"));
		listaClientes.add(new Cliente(77777777, "Juan Pérez", "Calle Falsa 123", 11223344, "juan@gmail.com"));
		listaClientes.add(new Cliente(88888888, "Juan Pérez", "Calle Falsa 123", 11223344, "juan@gmail.com"));
		listaClientes.add(new Cliente(99999999, "Juan Pérez", "Calle Falsa 123", 11223344, "juan@gmail.com"));
		listaClientes.add(new Cliente(12345678, "Juan Pérez", "Calle Falsa 123", 11223344, "juan@gmail.com"));
		listaClientes.add(new Cliente(234567891, "Juan Pérez", "Calle Falsa 123", 11223344, "juan@gmail.com"));
	}
